...
class GameFragment : Fragment() {
    ...
    private val viewModel: GameViewModel by viewModels {
        GameFragmentViewmodelFactory(DatabasePlayer.getInstance(this.requireContext()).playerDao, requireActivity().application)
    }
    ...
    private fun settingGame() {
        viewModel.setPlayer(settings.getLong("currentIdPlayer", -1))
